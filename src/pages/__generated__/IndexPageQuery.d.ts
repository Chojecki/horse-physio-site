...
export interface IndexPageQuery_oferta_edges_node_frontmatter_image_childImageSharp_fluid {
  base64: string | null;
  aspectRatio: number;
  src: string;
  srcSet: string;
...
export interface IndexPageQuery_oferta_edges_node_frontmatter_image_childImageSharp {
  fluid: IndexPageQuery_oferta_edges_node_frontmatter_image_childImageSharp_fluid | null;
}

export interface IndexPageQuery_oferta_edges_node_frontmatter_image {
  childImageSharp: IndexPageQuery_oferta_edges_node_frontmatter_image_childImageSharp | null;
}

export interface IndexPageQuery_oferta_edges_node_frontmatter {
  title: string;
  description: string | null;
  image: IndexPageQuery_oferta_edges_node_frontmatter_image | null;
}

export interface IndexPageQuery_oferta_edges_node_fields {
  slug: string | null;
}

export interface IndexPageQuery_oferta_edges_node {
  id: string;
  frontmatter: IndexPageQuery_oferta_edges_node_frontmatter | null;
  fields: IndexPageQuery_oferta_edges_node_fields | null;
}

export interface IndexPageQuery_oferta_edges {
  node: IndexPageQuery_oferta_edges_node;
}

export interface IndexPageQuery_oferta {
  edges: IndexPageQuery_oferta_edges[];
}
